...
class SMMAgentCheetah(DDPGAgent):
    ...
    def update(self, replay_iter, step):
        ...
        obs = obs[:, self.relevant_obs_dims]
        with torch.no_grad():
            next_obs = self.aug_and_encode(next_obs)
            next_obs_original = torch.clone(next_obs)
            next_obs = next_obs[:, self.relevant_obs_dims]
